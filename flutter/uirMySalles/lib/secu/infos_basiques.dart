...
class infosBasiques extends StatelessWidget {
    ...
    if (newName.isNotEmpty) {
      try {
        var response = await http.post(
          Uri.parse('http://127.0.0.1/api_flutter_1/validate/validatename.php'),
          body: {
            "name": newName,
            "username": us,
          },
  ...
  Future<void> validateUsername() async {
    ...
    if (newUsername.isNotEmpty) {
      try {
        var response = await http.post(
          Uri.parse('http://127.0.0.1/api_flutter_1/validate/validateusername.php'),
          body: {
  ...
  Future<void> validatePassword() async {
    ...
    if (pass.isNotEmpty) {
      try {
        var response = await http.post(
          Uri.parse('http://127.0.0.1/api_flutter_1/validate/validatepassword.php'),
          body: {
            "currentUsername":us,
            "password": pass
          },
