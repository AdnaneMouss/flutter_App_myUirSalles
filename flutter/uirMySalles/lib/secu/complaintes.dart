...
class _complainteState extends State<complaintes> {
  ...
  Future<bool> sendDataToPHP() async {
    final String url = 'http://127.0.0.1/api_flutter_1/insert/insertcomplaintaboutprof.php'; // Replace with your PHP script URL
    try {
  ...
  Future<List<String>> fetchSallesData(String username) async {
    final url = Uri.parse('http://127.0.0.1/api_flutter_1/retrieve/retrieveclassfrombatiment.php'); // Replace with your API endpoint
  ...
  Future<List<String>> fetchProfData() async {
    try {
      final response = await http.get(Uri.parse('http://127.0.0.1/api_flutter_1/retrieve/retrieveprofessors.php'));
