...
class _notifState extends State<notifications>{
  ...
  Future<List<dynamic>> fetchNotifications() async {
    final String url = 'http://127.0.0.1/api_flutter_1/retrieve/getNotifs.php'; // Replace with your PHP script URL
  ...
  Future<void> sendData(
    ...
    var url = Uri.parse('http://127.0.0.1/api_flutter_1/send/sendNotifToProf.php'); // Replace with your PHP endpoint
