...
class _notifState extends State<reservations>{
  ...
  Future<List<dynamic>> fetchReservations() async {
    final String url = 'http://127.0.0.1/api_flutter_1/retrieve/getReservationsForSecu.php';
  ...
  Future<void> sendData(
    ...
    var url = Uri.parse('http://127.0.0.1/api_flutter_1/send/sendNotifToSecu.php'); // Replace with your PHP endpoint
