...
class _complaintesState extends State<complaintesProf> {
  ...
  Future<bool> sendDataToPHP() async {
    final String url = 'http://127.0.0.1/api_flutter_1/insert/insertcomplaintaboutagent.php'; // Replace with your PHP script URL
    try {
  ...
  Future<List<String>> fetchSallesData() async {
    try {
      final response = await http.get(Uri.parse('http://127.0.0.1/api_flutter_1/retrieve/retrieveclass.php'));
