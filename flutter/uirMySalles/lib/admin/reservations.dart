...
class _reservations extends State<reservationsAdmin> {
  ...
  Future<List<String>> fetchProfData() async {
    try {
      final response = await http.get(Uri.parse(
          'http://127.0.0.1/api_flutter_1/retrieve/retrieveprofessorsusername.php'));
  ...
  Future<List<dynamic>> fetchComplaintes() async {
    final String url =
        'http://127.0.0.1/api_flutter_1/retrieve/getReservation.php'; // Replace with your PHP script URL
  ...
  Future<void> deleteReservation() async {
    final String url =
        'http://127.0.0.1/api_flutter_1/insert/deleteReservation.php';

    try {
      var response = await http.post(Uri.parse(url), body: {
        'idR': deleteById.toString(), // Convertir en chaîne de caractères
      });

      if (response.statusCode == 200) {
        // Gérer le succès
        print('Salle supprimée avec succès');
        // Mettre à jour l'interface utilisateur en récupérant la liste mise à jour des salles
        fetchAndSetComplaintes();
      } else {
  ...
  Future<void> addReservation(int salle, int etage, int batiment,
    ...
    final String url = 'http://127.0.0.1/api_flutter_1/insert/addReservation.php';
  ...
  Future<void> updateReservation(
      ...
      int batimentActuel,
      int dateResActuel,
      int heureActuel, // changer le type à int
      int profActuel,
      // changer le type à int
      ) async {
    final String url =
        'http://127.0.0.1/api_flutter_1/insert/updateReservation.php';
          ...
          showDialog(
            ...
            builder: (BuildContext context) {
              return AlertDialog(
                ...
                content: Container(
                  height: 352.0, // Set a smaller height
                  ...
                  child: Column(
                    children: [
                      ...
                      DateTimeField(
                        format: DateFormat("yyyy-MM-dd"), // Format de la date
                      ...
                      DropdownButtonFormField<String>(
                        value: selectedheure, // Valeur sélectionnée
