...
class _dashboardAdminState extends State<dashboardAdmin> {
  ...
  Future<int> getReservationsCountCercle() async {
    final response = await http
        .get(Uri.parse('http://127.0.0.1/api_flutter_1/retrieve/getdataSR.php'));
  ...
  Future<int> getNONreservationsCountCercle() async {
    final response = await http
        .get(Uri.parse('http://127.0.0.1/api_flutter_1/retrieve/getdataSNR.php'));
  ...
  Future<int> getComplaintsCount() async {
    final response = await http
        .get(Uri.parse('http://127.0.0.1/api_flutter_1/retrieve/getdata.php'));
  ...
  Future<int> getCompteCount() async {
    final response = await http.get(
        Uri.parse('http://127.0.0.1/api_flutter_1/retrieve/getdataCompte.php'));
  ...
  Future<int> getReservationsCount() async {
    final response = await http.get(Uri.parse(
        'http://127.0.0.1/api_flutter_1/retrieve/getdataReservation.php'));
  ...
  Future<int> getSallesCount() async {
    final response = await http.get(
        Uri.parse('http://127.0.0.1/api_flutter_1/retrieve/getdataSalles.php'));
