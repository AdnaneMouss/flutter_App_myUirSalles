...
class _affichage extends State<comptesAdmin> {
  ...
  Future<List<dynamic>> fetchAcc() async {
    const String url =
        'http://127.0.0.1/api_flutter_1/retrieve/getInfoAccounts.php';
    try {
  ...
  Future<void> deleteAcc() async {
    const String url = 'http://127.0.0.1/api_flutter_1/insert/deleteAccount.php';
  ...
  Future<void> addAcc(String username, String password, String name,String phonenumber, String email, String usertype,String batiment,String cours) async {
    String url = 'http://127.0.0.1/api_flutter_1/insert/addAccount.php'; // Remplacez par l'URL réelle de votre script PHP

    // Afficher les valeurs avant l'envoi de la requête
    print('Nom  : $username');
