...
class _compState extends State<complaintesAdmin>{
  ...
  void initState() {
    super.initState();
    fetchAndSetComplaintes();// Fetch notifications when the widget initializes
  }
  Future<List<dynamic>> fetchComplaintes() async {
    final String url = 'http://127.0.0.1/api_flutter_1/retrieve/getComplaintes.php'; // Replace with your PHP script URL
  ...
  Future<void> fetchAndSetComplaintes() async {
    var fetchedNotifications = await fetchComplaintes(); // Call the function to fetch notifications
    setState(() {
 ...
 // Adjust this height according to your preference
                      Text(
                        'Heure: ${list[i]['heure']}',
                        style: TextStyle(
                          fontSize: 11,
