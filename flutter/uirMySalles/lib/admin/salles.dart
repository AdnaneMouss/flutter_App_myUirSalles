...
class _affichage extends State<sallesAdmin> {
  ...
  Future<List<dynamic>> fetchComplaintes() async {
    final String url =
        'http://127.0.0.1/api_flutter_1/retrieve/getInfoSalles.php'; // Replace with your PHP script URL
  ...
  Future<void> addSalle(String numero, String etage, String batiment) async {
    final String url = 'http://127.0.0.1/api_flutter_1/insert/addSalle.php';
  ...
  Future<void> updateSalle(String etage, String batiment, String num,
    ...
    final String url = 'http://127.0.0.1/api_flutter_1/insert/update.php';
  ...
  Widget build(BuildContext context) {
    ...
    'Supprimer',
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        child: Text(
          '©Université internationale de RABAT-2023',
          textAlign: TextAlign.center,
        ),
      ),
                ...
                actions: <Widget>[
                  ...
                  ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      primary: Colors.white, // Choisir une couleur pour le bouton
                      onPrimary: drawerHeaderColor, // Choisir une couleur pour le texte du bouton
